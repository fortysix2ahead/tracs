...
def test_app_constructor_cfg_dir():
	...
	app =  Application.__new__( Application, config_dir=env_path, lib_dir=None, verbose=False, debug=False, force=False )
...
def test_app_constructor_lib_dir():
	env_path = get_config_path( 'debug', False )
	app =  Application.__new__( Application, config_dir=None, lib_dir=env_path, verbose=False, debug=False, force=False )
	home = Path.home()
...
def test_environment():
	...
	Application._instance = Application.__new__( Application, config_dir=None, lib_dir=None, verbose=False, debug=False, force=False ) # matches default object creation
	...
	Application._instance = Application.__new__( Application, config_dir=cfg_dir, lib_dir=None, verbose=None, debug=None, force=None ) # matches default object creation
	...
	Application._instance = Application.__new__( Application, config_dir=cfg_dir, lib_dir=None, verbose=None, debug=None, force=True ) # matches default object creation
	assert cfg['debug'].get() == True
	assert cfg['verbose'].get() == True
